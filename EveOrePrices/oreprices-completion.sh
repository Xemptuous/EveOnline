_autocompleteOres() 
{
  _autocomplete_commands=$(~/Scripts/oreprices shortlist)
    ...
    opts="arkonor bezdnacine bistot crokite dark_ochre gneiss hedbergite hemorphite jaspet kernite mercoxit omber plagioclase pyroxeres rakovene scordite spodumain talassonite veldspar bitumens carnotite chromite cinnabar cobaltite coesite euxenite loparite monazite otavite pollucite scheelite sperrylite sylvite titanite vanadinite xenotime ytterbite zeolites zircon blue_ice clear_icicle dark_glitter gelidus glacial_mass glare_crust krystallos white_glaze update"
